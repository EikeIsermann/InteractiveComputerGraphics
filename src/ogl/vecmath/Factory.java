...
public interface Factory {
  ...
  public abstract Vector vecX();
    
  public abstract Vector vecY();
    
  public abstract Vector vecZ();
    
  public abstract int vecSize(); 
    

  public abstract Matrix matIdent();
   ...
   * @return The matrix.
   */  
  public abstract Matrix mat(float m00, float m01, float m02, float m03, float m10,
   ...
   * @return The matrix.
   */ 
  public abstract Matrix mat(float[] elements);
  /**
   ...
   * @return The matrix.
   */
  public abstract Matrix mat(Vector b0, Vector b1, Vector b2);
   ...
   */
  public abstract Matrix matTrans(Vector t);
  /**
   * Construct a new matrix that represents a translation.
   * 
   * @param x, y, z
   ...
   * @return The translation matrix.
   */ 
  public abstract Matrix matTrans(float x, float y, float z);
  /**
   ...
   */
  public abstract Matrix matRot(Vector axis, float angle);
  /**
   * Construct a new matrix that represents a rotation.
   * 
   * @param x
   ...
   * @return The rotation matrix.
   */
  public abstract Matrix matRot(float ax, float ay, float az, float angle); 
  /**
   ...
   */
  public abstract Matrix matScale(Vector s); 
  /**
   * Construct a new matrix that represents a scale transformation.
   * 
   * @param x
   ...
   * @return The scale matrix.
   */
  public abstract Matrix matScale(float x, float y, float z); 
  /**
   ...
   * @return The rotation matrix.
   */
  public abstract Matrix matLookAt(Vector eye, Vector center, Vector up);
  /**
   ...
   * @return The rotation matrix.
   */
  public abstract Matrix matFrustum(float left, float right, float bottom,
   ...
   * @return The rotation matrix.
   */
  public abstract Matrix matPerspective(float fovy, float aspect, float zNear,
      float zFar); 
   ...
   * @return The object.
   */
  public abstract Color col(float r, float g, float b);
  /**
