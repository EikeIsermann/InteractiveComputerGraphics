...
public class RotatingCube implements App {
  ...
  static public void main(String[] args) {
    new OpenGLApp("Rotating Cube - OpenGL ES 2.0 (lwjgl)",
      new RotatingCube()).start();
  }
  ...
  public void init() {
    ...
    positionData = BufferUtils.createFloatBuffer(vertices.length * vecmath.vecSize());
    colorData = BufferUtils.createFloatBuffer(vertices.length * vecmath.colSize());
  ...
  public void display(int width, int height) {
    ...
    Matrix projectionMatrix = vecmath.matPerspective(60f, aspect, 0.1f, 100f);

    // The inverse camera transformation. World space to camera space.
    Matrix viewMatrix = vecmath.matLookAt(vecmath.vec(0f, 0f, 3f), vecmath.vec(0f,
      0f, 0f), vecmath.vec(0f, 1f, 0f));

    // The modeling transformation. Object space to world space.
    Matrix modelMatrix = vecmath.matRot(vecmath.vec(1, 1, 1), angle);
